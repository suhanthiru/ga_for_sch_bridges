# vendored from skill_chains@c1e0cbc (bridge_fast.py); imports rewritten, otherwise unchanged
...
def quad_Q(ref, g0, vnom, s, t, mf, mode):
    ...
    if mf.name == "se2x":
        ...
        from sb.core.se2 import adjoint_mat, exp_se2
...
def sample_and_target(ref, g0, prep, tau, mf, gen=None, backward=False):
    ...
    if mf.name == "se2x":
        from sb.core.se2 import adjoint, exp_se2
