...
seed genomes) and re-frozen through 2026-09-14 before any analysed pilot row (hash
c4891ed7e54cf4fd, component source hash ef80547caa604ca0; PLAN_CHANGES 2026-09-13, two
entries: the wired seam and trigger slots, then the drift controller's solver flags; and
2026-09-14, the tuned ablation counterfactual and the structural grammar hash): the pilot's root
